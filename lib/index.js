...
var METHOD = {
  thenMethod: function thenMethod(chains, callback) {
    var wrapped = (0, _compose2['default'])(setStatusWapper, thenerWrapper)(callback);
    return chains ? (0, _compose2['default'])(wrapped, chains) : wrapped;
  },
  catchMethod: function catchMethod(chains, callback) {
    var wrapped = (0, _compose2['default'])(catcherWrapper)(callback);
    return chains ? (0, _compose2['default'])(wrapped, tryWapper(chains)) : wrapped;
  },
  finallyMethod: function finallyMethod(chains, callback) {
    var wrapped = (0, _compose2['default'])(throwWapper)(callback);
    return chains ? (0, _compose2['default'])(wrapped, tryWapper(chains)) : wrapped;
  },
  thenSyncMethod: function thenSyncMethod(callback) {
    return (0, _compose2['default'])(delayThrow, setStatusWapper, thenerWrapper)(callback);
  },
  ...
  finallySyncMethod: function finallySyncMethod(callback) {
    return (0, _compose2['default'])(delayThrow, notThrowWapper)(callback);
  }
};
